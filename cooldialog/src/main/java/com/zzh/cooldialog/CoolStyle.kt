...
data class CoolStyle(var mTargetView: View?, var mStyle: Int = COOL_STYLE_SLIDE_BOTTOM) {
    ...
    private fun getShakeAnimators(view: View?): Collection<Animator>? = takeIf { view != null }?.run {
        arrayListOf(
                ObjectAnimator.ofFloat(view, "translationX", 0f, .10f, -25f, .26f, 25f, .42f, -25f, .58f, 25f, .74f, -25f, .90f, 1f, 0f).setDuration(mDuration)
        )
    }
    ...
    private fun get3DSlitHAnimators(view: View?): Collection<Animator>? = takeIf { view != null }?.run {
        arrayListOf(
                ObjectAnimator.ofFloat(view, "rotationY", 90f, 88f, 88f, 45f, 0f).setDuration(mDuration),
                ObjectAnimator.ofFloat(view, "alpha", 0f, 0.4f, 0.8f, 1f).setDuration(mDuration * 3 / 2),
    ...
    private fun get3DSlitVAnimators(view: View?): Collection<Animator>? = takeIf { view != null }?.run {
        arrayListOf(
                ObjectAnimator.ofFloat(view, "rotationX", 90f, 88f, 88f, 45f, 0f).setDuration(mDuration),
                ObjectAnimator.ofFloat(view, "alpha", 0f, 0.4f, 0.8f, 1f).setDuration(mDuration * 3 / 2),
                ObjectAnimator.ofFloat(view, "scaleX", 0f, 0.5f, 0.9f, 0.9f, 1f).setDuration(mDuration),
                ObjectAnimator.ofFloat(view, "scaleY", 0f, 0.5f, 0.9f, 0.9f, 1f).setDuration(mDuration)
        )
